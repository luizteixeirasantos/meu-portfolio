  ...
  return (
    <div className="portfolio-container dark-theme">
      ...
      <nav className="main-nav">
        <h1 className="logo" style={{ cursor: "default" }}>
          LUIZ HENRIQUE
        </h1>
        ...
        >
          ...
          <div className="hero-content">
            ...
            <h2 className="subtitle">
              ...
              <span className="text-purple" style={{ cursor: "default" }}>
                FULL STACK
              </span>
            </h2>
      ...
      <section className="skills-section" id="skills">
        <h2 className="section-title text-center" style={{ cursor: "default" }}>
          SKILLS
        </h2>

        <div className="skills-category">
          <h3
            className="skills-subtitle text-light-green"
          ...
          <div className="skills-grid">
            {hardSkills.map((hab, index) => (
              <motion.div
                ...
                key={index}
                style={{ "--skill-color": hab.cor, cursor: "default" }}
        ...
        <div className="skills-category">
          <h3
            className="skills-subtitle text-purple"
            style={{ cursor: "default" }}
          >
            SOFT SKILLS
          </h3>
            ...
            >
              ...
              <div className="modal-footer">
                ...
                >
                  <FaGithub
                    className="FaGithub"
                    style={{ fill: "#fff", fontSize: "1.3rem" }}
                  />{" "}
                  GitHub
                </a>
      ...
      <footer className="main-footer" id="contact">
        ...
        <p className="footer-bottom" style={{ cursor: "default" }}>
          Copyright © 2026 Luiz Henrique.
        </p>
      </footer>
    </div>
  );
